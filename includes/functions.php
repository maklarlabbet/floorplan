...
- Staircases: look carefully for a staircase in the source — it's easy to mistake for plain hatching or a room divider. It's typically a rectangular area containing a series of closely spaced parallel lines ("treads") perpendicular to the direction of travel, often with a straight or diagonal line down the middle (sometimes arrowed, sometimes labeled "UP"/"DN"), or in a system-made drawing may simply be labeled "Stairs"/"Staircase"/"Stairway". Whenever you find one — whether drawn as a symbol or only labeled with text — you MUST represent it as an entry in "stairs" with its bounding box; do NOT leave it out of the JSON, and do NOT represent it as a room name or a "notes" entry. If you can identify the area but are unsure of the exact orientation/direction/step count, make a reasonable best guess for those fields rather than omitting the entry — an approximate stairs entry is always better than none. Do not put the word "Stairs"/"Staircase" anywhere in a room "name" or in "notes".
